...
<div class="row" style="padding:80px 20px">
  ...
  <div class="row" style="margin-left:0;margin-bottom:20px;">
	...
	<div class="col-xs-2 col-md-2 ">
           <a ng-click="addEdit()" style="width:80px;color: #fff;background-color: #5bc0de;border-color: #46b8da;padding-top: 10px;text-align: center;padding-bottom: 10px;border-radius: 4px;display:block"  >添加
           </a>
      </div>
  </div>
