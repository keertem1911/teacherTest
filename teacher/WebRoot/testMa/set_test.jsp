	...
	<div class="col-md-9">
		<div class="row">
			<div class="col-xs-6 col-md-4 ">
		        <a href="./stu_select_zuoye.jsp" class="thumbnail"  target="_blank">
		          <img src="../images/1.png" alt="">
		              <h5>添加试卷</h5>
		        </a>
		     </div>
			<div class="col-xs-6 col-md-4 ">
		         <a href="./stu_radom_zuoye.jsp" class="thumbnail"  target="_blank">
		          <img src="../images/1.png" alt="">
		              <h5>随机生成试卷</h5>
		        </a>
		    </div>
		    <div class="col-xs-6 col-md-4 ">
		         <a href="./testFin.jsp" class="thumbnail"  target="_blank">
		          <img src="../images/1.png" alt="">
		              <h5>查看试卷</h5>
		        </a>
		    </div>
