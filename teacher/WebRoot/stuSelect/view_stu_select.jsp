        ...
        <li class="list-group-item"  data-toggle="collapse" href="#collapseNote" >
         ...
         <div id="collapseNote">
           <table class="table table-condensed" style="margin-bottom:0">
             <tr><td><a href="./view_stu_select.jsp">查看选课学生</a></td></tr>
...
<div class="col-md-9">
<div class="row">
            <iframe frameborder="0" name="mainFrame" src="view_stu_select_selection.html" width="100%" height="500px" align="left" scrolling="no" target="_self">
            </iframe>
</div>
</div>
